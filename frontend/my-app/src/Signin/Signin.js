                    ...
                    <div className="box3">
                        ...
                        <div className="right3">
                            ...
                            <input
                                ...
                                placeholder="Email"
                                className="email3"
                                style={{ borderColor: this.state.borderColor.email }}
                            ...
                            <input
                                ...
                                className="pwd3"
                                ref={this.pwdRef}
                                style={{ borderColor: this.state.borderColor.pwd }}
                            ...
                            <div className="button3" onClick={this.checkInputs}>
                                Sign In
                            </div>
                            ...
                            <p className="account3">
                                ...
                                <span className="signup3" onClick={() => this.changePage("signup")}>SIGN UP</span>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="background3">
                    <div className="box3">
                        ...
                        <div className="right3">
                            ...
                            <div className="button3" onClick={this.checkInputs2}>
                                Sign In
                            </div>
