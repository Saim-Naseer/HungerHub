...
const StatusBar = (props) =>{
    return(
        <>
            <div className="c_statusbar" style={{position:"relative",left:"80px"}} >
                ...
                <div className="c_circle" style={{border:"10px solid #22476D"}}><p>4</p></div>
                <p className="c_statustext">Wait</p>
